...
class Gallery extends Component {
  render() {
    const description = {
      ...
      jlusa:
        "Mass incarceration is the most significant domestic threat to the fabric of our democracy. It's not caused by serious crimes, but by misguided policies such as mandatory minimums, three-strikes laws and reductions in the availability of parole and other early release mechanisms.",
      crj:
      ...
      vera:
        "The ICH program educates non-detained immigrants in deportation proceedings about the court process. The goal of ICH is to help individuals make informed decisions about their legal cases and improve immigration court proceedings.",
      blm:
